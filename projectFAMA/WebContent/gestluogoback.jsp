...
<title>JSP List Places Records</title>
...
<body>
<form action="gestluogoBackServlet" method="get">
    <sql:setDataSource
        var="myDS"
   ...
   <div style = 'text-align: right'> <a   href="insertLuogoBack.jsp"><img  align="center" src="images/plus.jpg"></a>   INSERT PLACE</div><br>
            <caption><h1>PLACES</h1></caption>
            <thead>
	            <tr>
	              	<th>IdLuogo</th>
	                <th>NomeCitta</th>
            ...
            <c:forEach var="user" items="${Customerlist.rows}">
                <tr>
                    ...
                    <td><c:out value="${user.NomeCitta}" /></td>
                    <td><c:out value="${user.NomeRegione}" /></td>
                    <td><c:out value="${user.Provincia}" /></td>
                    <td><c:out value="${user.img}" /></td>
                   
<td><a	href="gestluogoBackServlet?cmd=elimina&id=${user.IdLuogo}"> <img src="images/delete.jpg"></td>
