<%@ page language="java"  import="java.util.*,projectFAMA.*"contentType="text/html; charset=ISO-8859-1"
...
<%! ArrayList<Hotel> elenco;
	...
	DBManager db;
<%
elenco = (ArrayList<Hotel>) session.getAttribute("ELENCO_HOTEL");
%>
<!doctype html>
<html lang="en">
...
<body>
	...
	<section class="services" id="servizi">
		<div class="container">
			...
			<div class="container">
				<table style="width:100%" height="500%" class="single-pricing text-center" data-aos="fade-up"
					...
					<tr>
			<td><a
				href="GestioneHotelServlet?cmd=cerca&id=<%=h.getIdHotel()%>"></a></td>
			<td><%=h.getNome() %>
			<%=h.getIndirizzi()  %>
			<%=h.getTelefono() %>
			<%=h.getEmail() %>
		...
		%>
				 ...
				 <a href="#servizi" data-aos="fade-right" data-aos-delay="900"
								href="#" class="btn btn-primary"> Prenota</a>
			</div>
			<!-- <div class="container">
                <div class="row">
