<%@ page language="java"  import="java.util.Locale" import="org.apache.tomcat.jni.Local" import="projectFAMA.Utente" contentType="text/html; charset=ISO-8859-1"
                ...
                <a class="search-icon d-none d-md-block" href="#"><i class="fa fa-search"></i></a>
                 <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#offerte"><fmt:message key="offerte" bundle="${resourceBundle}"/></a></li>
                        <li class="nav-item"><a class="nav-link" href="#mete"><fmt:message key="mete" bundle="${resourceBundle}"/></a></li>
                        <li class="nav-item"><a class="nav-link" href="prenotazione.jsp"><fmt:message key="prenota" bundle="${resourceBundle}"/></a></li>
                 ...
                 <div class="dropdown">
  					<a class="dropbtn">Lingue</a>
  						<div class="dropdown-content">
    						<a href="home.jsp?locale=it_IT"><img src="images/italia.png" width="50"></a>
							<a href="home.jsp?locale=en_US"><img src="images/inglese.jpg" width="50"></a>
    						<a href="home.jsp?locale=fr_FR"><img src="images/francia.png" width="50"></a>
    						<a href="home.jsp?locale=es_US"><img src="images/spagna.png" width="50"></a>
  						</div>
				</div>
                    </ul>
                        ...
                        <!-- <div class="swiper-wrapper">-->
                            <div class="swiper-slide slide-content d-flex align-items-center">
                                <div class="single-slide">
                                    <h1 data-aos="fade-right" data-aos-delay="200"><fmt:message key="ben" bundle="${resourceBundle}"/> <%=user%>
                                    <br>
                                    </h1>
                                    <p data-aos="fade-right" data-aos-delay="600"><fmt:message key="ben1" bundle="${resourceBundle}"/>
                                    </p>
        ...
        <div class="container">
         <div class="title text-center">
               <h6 class="title-primary"><fmt:message key="team" bundle="${resourceBundle}"/></h6>
                <h1 class="title-blue"><fmt:message key="migliori" bundle="${resourceBundle}"/></h1>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right"
                        ...
                        <div class="post-content text-sm-right">
                            ...
                            <h3><a href="#"><fmt:message key="migliori1" bundle="${resourceBundle}"/></a></h3>
                            <p><fmt:message key="luoghi1" bundle="${resourceBundle}"/></p>
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-duration="800">
                        ...
                        <div class="post-content">
                            <!--<time datetime="2019-04-06T13:53">15 Oct, 2019</time>   -->
                            <h3><a href="#"><fmt:message key="migliori2" bundle="${resourceBundle}"/></a></h3>
                            <p><fmt:message key="luoghi2" bundle="${resourceBundle}"/></p>
                            <!--  <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>-->
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right" data-aos-delay="200"
                        ...
                        <div class="post-content text-sm-right">
                             <!--<time datetime="2019-04-06T13:53">15 Oct, 2019</time>   -->
                            <h3><a href="#"><fmt:message key="migliori3" bundle="${resourceBundle}"/></a></h3>
                            <p><fmt:message key="luoghi3" bundle="${resourceBundle}"/></p>
                            <!--  <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>-->
                        </div>
                        <div class="post-thumb">
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-delay="200"
                        ...
                        <div class="post-content">
                             <!--<time datetime="2019-04-06T13:53">15 Oct, 2019</time>   -->
                            <h3><a href="#"><fmt:message key="migliori4" bundle="${resourceBundle}"/></a></h3>
                            <p><fmt:message key="luoghi4" bundle="${resourceBundle}"/></p>
                         <!--  <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>-->
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center">
                <a href="prenotazione.jsp" class="btn btn-primary"><fmt:message key="pre" bundle="${resourceBundle}"/></a>
            </div>
        </div>
    </section>
    <!-- Recent Posts End -->
            ...
            <div class="row no-gutters">
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="0"
                        ...
                        <p><img src="images/firenze.jpg" width=350px ><br><br></p>
                        <a href="" class="btn btn-primary"><fmt:message key="pre" bundle="${resourceBundle}"/></a> 
                ...
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="300"
                        ...
                        <p><img src="images/roma.jpg" width=350px><br><br></p>
                         <a href="" class="btn btn-primary"><fmt:message key="pre" bundle="${resourceBundle}"/></a>
                        <svg viewBox="0 0 170 193">
                            <path fill-rule="evenodd" fill="rgb(238, 21, 21)"
                                d="M39.000,31.999 C39.000,31.999 -21.000,86.500 9.000,121.999 C39.000,157.500 91.000,128.500 104.000,160.999 C117.000,193.500 141.000,201.000 150.000,183.000 C159.000,165.000 172.000,99.000 167.000,87.000 C162.000,75.000 170.000,63.000 152.000,45.000 C134.000,27.000 128.000,15.999 116.000,11.000 C104.000,6.000 89.000,-0.001 89.000,-0.001 L39.000,31.999 Z" />
                ...
                <div class="col-md-4">
                    <div class="single-pricing text-center" data-aos="fade-up" data-aos-delay="600"
                        ...
                        <p><img src="images/venecia.jpg" width=350px> <br><br></p>
                        <a href="" class="btn btn-primary"><fmt:message key="pre" bundle="${resourceBundle}"/></a>
                        <svg viewBox="0 0 170 193">
                            <path fill-rule="evenodd" fill="rgb(238, 21, 21)"
                                d="M39.000,31.999 C39.000,31.999 -21.000,86.500 9.000,121.999 C39.000,157.500 91.000,128.500 104.000,160.999 C117.000,193.500 141.000,201.000 150.000,183.000 C159.000,165.000 172.000,99.000 167.000,87.000 C162.000,75.000 170.000,63.000 152.000,45.000 C134.000,27.000 128.000,15.999 116.000,11.000 C104.000,6.000 89.000,-0.001 89.000,-0.001 L39.000,31.999 Z" />
